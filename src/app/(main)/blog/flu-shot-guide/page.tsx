      ...
      <section className="relative" style={{ background: "hsl(210, 32%, 8%)" }}>
        ...
        <div className="container mx-auto px-5 lg:px-8 py-12">
          <article className="max-w-4xl mx-auto">
            ...
            <h2 className="text-2xl lg:text-3xl font-bold mb-6" style={{ color: `rgb(${A.rgb})` }}>How the Flu Shot Actually Works</h2>
            ...
            <h2 className="text-2xl lg:text-3xl font-bold mb-6" style={{ color: `rgb(${A.rgb})` }}>Safety: What the Data Shows</h2>

            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="rounded-2xl p-6" style={{ background: `rgba(${A.rgb},0.08)`, border: `1px solid rgba(${A.rgb},0.2)` }}>
                <h3 className="font-bold mb-4" style={{ color: `rgb(${A.rgb})` }}>Common Side Effects</h3>
                <div className="space-y-2">
                  {["Sore arm at injection site (~60%)", "Low-grade fever (uncommon)", "Muscle aches for 1–2 days", "Mild fatigue"].map((item, i) => (
                    <div key={i} className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: `rgb(${A.rgb})` }} />
            ...
            <div className="rounded-2xl p-7 mb-10 text-center" style={{ background: `linear-gradient(135deg, hsla(280,70%,55%,0.12), rgba(${A.rgb},0.12))`, border: "1px solid hsla(280,70%,55%,0.25)" }}>
            ...
            <h2 className="text-2xl lg:text-3xl font-bold mb-5" style={{ color: `rgb(${A.rgb})` }}>Who Should Get Vaccinated?</h2>
            ...
            <div className="rounded-2xl p-6 mb-8" style={{ background: "hsla(210, 22%, 18%, 0.8)" }}>
              <h2 className="text-xl font-bold mb-3" style={{ color: `rgb(${A.rgb})` }}>The Bottom Line</h2>
            ...
            <div className="mb-8">
              <BlogCtaBlock
                service="brand"
                source="blog-flu-shot-guide"
                appt="meetGreet"
                heading="Ready to Protect Yourself This Flu Season?"
                body="As a Colorado Springs Health Collective member, you have direct access to your providers for questions about flu vaccination and other preventive care."
              />
            </div>
            ...
            <div className="rounded-3xl p-6 mb-8" style={{ background: "hsla(210, 22%, 28%, 0.75)" }}>
              ...
              <div className="space-y-2">
                <Link href="/blog/dpc-vs-concierge" className="block hover:opacity-80" style={{ color: `rgb(${A.rgb})` }}>
                  → Direct Primary Care vs. Concierge Medicine: Colorado Springs Guide
                </Link>
                <Link href="/blog/why-direct-primary-care" className="block hover:opacity-80" style={{ color: `rgb(${A.rgb})` }}>
