      ...
      <section className="relative" style={{ background: "hsl(210, 32%, 8%)" }}>
        ...
        <div className="container mx-auto px-5 lg:px-8 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            {/* CTA */}
            <div className="rounded-3xl p-8 lg:p-10 text-center" style={{ background: "linear-gradient(135deg, hsla(331,70%,55%,0.15), hsla(271,70%,55%,0.15))", border: "1px solid hsla(331,70%,55%,0.3)" }}>
              <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: "hsl(331, 70%, 75%)" }}>Colorado Springs Health Collective</p>
              <h3 className="text-2xl lg:text-3xl font-bold mb-3" style={{ color: "hsl(0, 0%, 100%)" }}>
                Start With the System That Carries the Hormones
              </h3>
              <p className="mb-6 max-w-lg mx-auto" style={{ color: "hsl(210, 30%, 80%)" }}>
                Book a free consult to talk through your symptoms, your metabolic picture, and what a personalized plan would look like — before any prescription.
              </p>
              <a
                href={HORMONE_CONSULT_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-8 py-4 rounded-full font-semibold text-lg"
                style={{ background: "linear-gradient(135deg, hsl(331,70%,60%), hsl(271,70%,60%))", color: "hsl(0, 0%, 100%)", boxShadow: "0 8px 32px hsla(331,70%,50%,0.3)" }}
              >
                Book a Free Consult
              </a>
