...
const faqs = [
  ...
  },
  {
    ...
    answer: `CSHC Direct Primary Care is our membership-based primary care practice — unlimited visits, same-day access, and at-cost labs and medications for a flat monthly fee. CSHC Hormone & Weight Loss Clinic offers clinician-guided hormone optimization for men and women, including GLP-1 weight loss therapy (semaglutide, tirzepatide) and comprehensive HRT. CSHC Hyperbaric (opening ${clinicFacts.hbot.openingDate}) will bring Colorado Springs' only accessible ${clinicFacts.hbot.pressure} hyperbaric oxygen chamber — the same pressure used in clinical research. All three divisions are designed to work together so your care is coordinated, not fragmented.`,
  },
  {
    id: "membership-required",
    question: "Do I need a DPC membership to use the Hormone Clinic or Hyperbaric?",
    answer: "No — each CSHC division operates independently and is accessible without a DPC membership. That said, DPC members receive integrated care, priority access, and member pricing across all divisions. If you're already a DPC member, your provider coordinates your care across all three services. If you're not a DPC member, you can still access the Hormone & Weight Loss Clinic today — and Hyperbaric when it opens — as standalone services.",
  },
  {
    id: "member-priority",
    question: "Will DPC members get priority access and discounted pricing at the Hormone & Weight Loss Clinic and Hyperbaric?",
    answer: "Yes. DPC members are part of the CSHC collective and receive priority access and member pricing — at the Hormone & Weight Loss Clinic today, and at Hyperbaric when it opens. Member pricing across all divisions is part of the value of being a CSHC Direct Primary Care member. Your DPC provider is also directly involved in coordinating your care across divisions, so nothing falls through the cracks.",
  },
  {
    id: "insurance",
    question: "Do you accept insurance?",
    answer: `CSHC Direct Primary Care is not insurance and does not bill insurance — it's a flat monthly membership. Many members pair DPC with a high-deductible plan or catastrophic coverage for hospitalizations and specialist care. The Hormone & Weight Loss Clinic operates on transparent cash-pay pricing, and Hyperbaric will too. We also offer standalone urgent care services (Telehealth ${usd(clinicFacts.urgentCare.telehealth)}, In-home ${usd(clinicFacts.urgentCare.inPerson)}) for non-members, with superbills available upon request.`,
  },
  {
    id: "location",
    question: "Where are you located — and how does mobile and virtual care work?",
    answer: "CSHC is based in Colorado Springs, Colorado. Our Direct Primary Care and Urgent Care services are mobile and virtual — we come to you (home, office, or wherever works) or connect via telehealth. You don't need to come to a clinic. The Hyperbaric chamber will have a physical location in Colorado Springs (to be announced). The Hormone & Weight Loss Clinic offers both in-person and virtual options.",
  },
  {
    id: "timeline",
    question: "When will Hyperbaric open?",
    answer: `The Hormone & Weight Loss Clinic is accepting patients — book a free consult to get started. CSHC Hyperbaric is planned to open ${clinicFacts.hbot.openingDate}. We'll be the only non-hospital ${clinicFacts.hbot.pressure} chamber in Colorado Springs — early access members receive ${clinicFacts.hbot.earlyAccessDiscountPercent}% off when we open.`,
  },
  {
    id: "get-started",
    question: "How do I get started?",
    answer: `The best first step is a free Meet & Greet with Logan or Sarah. This is an informal conversation — no commitment, no paperwork — just a chance to see if CSHC is the right fit for your health goals. You can also reach us directly at ${clinicFacts.contact.phone} or ${clinicFacts.contact.email}. If you're interested in hormone care, book a free consult — the clinic is accepting patients. For Hyperbaric, contact us to get on the early access list.`,
  },
];
