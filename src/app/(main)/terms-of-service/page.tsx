...
export default function TermsOfService() {
  const sections = [
    { heading: "1) Who We Are & How to Reach Us", content: <><p className="mb-2">COBC Brands Direct Primary Care LLC d/b/a Colorado Springs Health Collective – Direct Primary Care</p><p className="mb-2">1497 Solitaire St, Colorado Springs, CO 80905</p><p>Email: {clinicFacts.contact.email}</p></> },
    ...
    { heading: "7) Privacy & Data Protection", content: <ul className="list-disc pl-6 space-y-2"><li><strong>HIPAA/PHI:</strong> Our use/disclosure of protected health information (PHI) is governed by our Notice of Privacy Practices (NPP); please review it carefully.</li><li><strong>Web privacy:</strong> Personal information collected on our public websites is governed by our Privacy Policy (separate from the NPP).</li><li><strong>Contact for privacy questions/rights:</strong> Privacy Officer at {clinicFacts.contact.email}.</li></ul> },
