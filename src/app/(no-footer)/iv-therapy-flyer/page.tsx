...
import { Droplets, Phone, Zap, Pill, CheckCircle, ArrowRight, MessageCircle } from "lucide-react";

export default function IVTherapyFlyer() {
  ...
  return (
    <div className="iv-flyer-container">
      <style>{`
        @media print {
          ...
          .iv-flyer-container { padding: 0 !important; margin: 0 !important; min-height: auto !important; background: transparent !important; }
        ...
        .iv-flyer-container { background: #f7fafc; min-height: 100vh; padding: 1rem; font-family: 'Poppins', system-ui, -apple-system, sans-serif; }
        ...
        .iv-label { font-size: 13pt; font-weight: 600; color: #ffffff; margin-bottom: 0.12in; letter-spacing: 0.5px; }
        ...
        .subheadline { font-size: 14pt; color: #e2e8f0; margin-bottom: 0.15in; line-height: 1.4; }
        .tagline { font-size: 12pt; color: #4fd1c7; font-weight: 600; }
        ...
        .box-list { font-size: 10pt; color: #cbd5e0; line-height: 1.6; }
        .box-list li { margin-bottom: 0.08in; padding-left: 0.15in; position: relative; }
        ...
        .service-icon.hydration { background: linear-gradient(135deg, #4fd1c7, #63b3ed); }
        .service-icon.headache { background: linear-gradient(135deg, #f6ad55, #ed8936); }
        .service-icon.nausea { background: linear-gradient(135deg, #68d391, #48bb78); }
        .service-icon.recovery { background: linear-gradient(135deg, #63b3ed, #805ad5); }
        ...
        .cta-section { background: linear-gradient(135deg, rgba(79,209,199,0.2), rgba(99,179,237,0.2)); border: 2px solid #4fd1c7; border-radius: 12px; padding: 0.25in 0.3in; text-align: center; margin-bottom: 0.2in; }
        .cta-headline { font-size: 16pt; font-weight: 700; color: #4fd1c7; margin-bottom: 0.1in; display: flex; align-items: center; justify-content: center; gap: 0.1in; }
        .cta-text { font-size: 12pt; color: #e2e8f0; margin-bottom: 0.08in; }
        .cta-action { font-size: 14pt; font-weight: 700; color: #f6e05e; }
        ...
        .contact-item { display: flex; align-items: center; gap: 0.08in; color: #1a202c; font-size: 12pt; font-weight: 600; }
      ...
      <div className="flyer-preview">
        <div className="preview-label no-print">IV THERAPY FLYER - 8.5" x 11"</div>
        <div className="flyer-page">
          <div className="flyer-content">
            <div className="header-section">
              <img src="/logo-main.png" alt="Colorado Springs Health Collective" className="logo-header" />
              <div className="iv-label">— Mobile IV Therapy —</div>
              <div className="headline">Last night was fun.<br />This morning isn't.</div>
              <div className="subheadline">We come to you with fast relief.</div>
              <div className="tagline">Feel human again in 30 minutes</div>
            </div>

            <div className="problem-solution">
              <div className="problem-box">
                <div className="box-title">The Morning After</div>
                <ul className="box-list">
                  <li>Pounding headache</li>
                  <li>Nausea that won't quit</li>
                  <li>Completely dehydrated</li>
                  <li>Can't keep anything down</li>
                  <li>Too tired to function</li>
                </ul>
              </div>
              <div className="solution-box">
                <div className="box-title"><CheckCircle style={{ width: 14, height: 14 }} /> Our IV Solution</div>
                <ul className="box-list">
                  <li>IV fluids for fast rehydration</li>
                  <li>Headache cocktails that work</li>
                  <li>Nausea meds for instant relief</li>
                  <li>Upset stomach treatment</li>
            ...
            <div className="services-section">
              <div className="services-title">What We Bring To You</div>
              <div className="services-grid">
                <div className="service-card"><div className="service-icon hydration"><Droplets /></div><div className="service-name">IV<br />Hydration</div></div>
                <div className="service-card"><div className="service-icon headache"><Zap /></div><div className="service-name">Headache<br />Cocktails</div></div>
                <div className="service-card"><div className="service-icon nausea"><Pill /></div><div className="service-name">Nausea<br />Meds</div></div>
                <div className="service-card"><div className="service-icon recovery"><ArrowRight /></div><div className="service-name">Fast<br />Recovery</div></div>
              </div>
            </div>

            <div className="cta-section">
              <div className="cta-headline"><ArrowRight style={{ width: 18, height: 18 }} /> Feel Better Fast</div>
              <div className="cta-text">We come to your home, hotel, or wherever you are.</div>
              <div className="cta-action">Call or Text Us Now</div>
            </div>
            ...
            <div className="footer-section">
              <div className="contact-strip">
                <div className="contact-info">
                  ...
                  <div className="contact-item"><MessageCircle /><span>Call or Text Anytime</span></div>
                </div>
